            ...
            <div class="modal-block__sidebar">
                ...
                <div class="nav flex-column" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <a class="" id="v-pills-settings-tab" data-toggle="pill" href="#v-pills-3" role="tab"
                       aria-controls="v-pills-settings" aria-selected="false">Партнёр<span class="cunter-info">1</span></a>
                </div>
            </div>
                        ...
                        <div class="chat">
                            ...
                            <div name="message" class="message-form">
                                <div class="d-flex">
                                    ...
                                    <input name="usermsg" id="message" type="text" placeholder="Текст сообщения"
                                           class="message-input">
                        ...
                        <div class="chat">
                            ...
                            <div class="chat__list mk">
                                ...
                                <div class="d-flex">
                                    ...
                                    <input name="usermsg" type="text" placeholder="Текст сообщения"
                                           class="message-input">
