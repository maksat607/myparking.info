            ...
            <div class="modal-block__sidebar">
                ...
                @if(auth()->user()->hasRole(['Partner,PartnerOperator']))
                    <div class="nav flex-column" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <a class="" id="v-pills-settings-tab" data-toggle="pill" href="#v-pills-1" role="tab"
                           aria-controls="v-pills-settings" aria-selected="true">Стоянка</a>
                        <a class="active" id="v-pills-settings-tab" data-toggle="pill" href="#v-pills-3" role="tab"
