        ...
        <div class="modal-block__body">
            <div class="modal-block__sidebar">
                ...
                <div class="nav flex-column" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    <a class="active" id="v-pills-settings-tab" data-toggle="pill" href="#v-pills-1" role="tab" aria-controls="v-pills-settings" aria-selected="true">Стоянка</a>
                    <a class="" id="v-pills-settings-tab" data-toggle="pill" href="#v-pills-3" role="tab" aria-controls="v-pills-settings" aria-selected="false">Партнёр<span class="cunter-info">1</span></a>
                </div>
            </div>
                            ...
                            <div class="chat__list">
                                <div class="chat__item">
                                    ...
                                    <div class="chat__mess">
                                        11111Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                        ...
                        <div class="chat">
                            ...
                            <form name="message" action="" class="message-form">
                                <div class="d-flex">
                                    ...
                                    <input name="usermsg" type="text" placeholder="Текст сообщения" class="message-input">
