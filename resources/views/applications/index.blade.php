                        ...
                        <div class="car-col__item">
                            ...
                            <div class="car-slide-wrap ">
                                ...
                                <div class="car-slide">
                                    ...
                                    @else
                                        <div class="newcart__imgwrap">
                                            <img src="{{ $application->default_attachment->thumbnail_url }}"
                                                 class="car-row__image">
                                        </div>
                                    @endif
                                </div>
                            </div>
                            <div
                                ...
                                <div class="car-col__info-item">
                                    <div class="car-status-wrap">
                                        ...
                                        @endif
                                        <span
                                            class="car-status {{ $application->status->getColorClass() }}">{{$application->status->name}}</span>
                                            ...
                                            @if($application->acceptions && $user->hasRole(['SuperAdmin', 'Admin','Moderator', 'Manager']))
                                                @can('application_to_accepted')
                                                    <a href="{{ route('applications.edit', ['application' => $application->id]) }}"
                                                       class="text-success btn">Принять</a>
