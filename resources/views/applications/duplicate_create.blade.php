            ...
            <div class="tabform__wrap">
                ...
                <form method="POST" action="{{ route('applications.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="tabform__footer">
                        ...
                        <label class="tabform__checkbox" id="returned">
                            <input type="checkbox" name="car_data[returned]" value="1" checked>
                            <span class="tabform__checkboxnew"></span> Повтор
                        </label>

                        <button class="tabform__footerbtn bgpink">Сохранить</button>
