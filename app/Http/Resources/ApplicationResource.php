...
class ApplicationResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return array_filter([
            ...
            "formated_created_at" => $this->formated_created_at ,
            "formated_updated_at" => $this->formated_updated_at ,
            "formated_arriving_at" => $this->formated_arriving_at ,
            "formated_arrived_at" => $this->formated_arrived_at ,
            "formated_issued_at" => $this->formated_issued_at ,
        ]);
    }
}
